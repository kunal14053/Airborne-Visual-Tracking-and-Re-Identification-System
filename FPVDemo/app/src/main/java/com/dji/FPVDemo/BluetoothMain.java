...
public class BluetoothMain  extends Activity implements SurfaceTextureListener,OnClickListener {
    ...
    public static final String urlUpload2 = "http://192.168.1.187:8000/getIndex";
                            ...
                            new Response.Listener<JSONObject>() {
                                ...
                                public void onResponse(JSONObject jsonObject) {
                                    ...
                                    try {
                                        ...
                                        //showToast("Got the ID: "+response_index);
    ...
    private SmoothBluetooth.Listener mListener = new SmoothBluetooth.Listener() {
        ...
        public void onDataReceived(int data) {
            ...
            showToast("DataRecieved");
            mRecordBtn.setChecked(true);
            startRecord();
            /*JsonObjectRequest getRequest = new JsonObjectRequest(Request.Method.GET, urlUpload2, null,
                    new Response.Listener<JSONObject>()
                    {
                        @Override
                        public void onResponse(JSONObject response) {
                            ...
                            try {
                                ...
                                index_flag=(int) response.get("index");
                                showToast("Got the RE-ID: "+index_flag);
                                mRecordBtn.setChecked(true);
                                startRecord();
                            } catch (JSONException e) {
                                e.printStackTrace();
                    ...
                    new Response.ErrorListener()
                    {
                        ...
                        public void onErrorResponse(VolleyError error) {
                            showToast("Volley Error Occurred "+error);
                        }
                    }
            );

            getRequest.setRetryPolicy(new DefaultRetryPolicy(10000, 0,(float)2.0));
